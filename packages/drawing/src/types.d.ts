export declare const SCENE_VERSION: 2;
export declare const DEFAULT_DARK_BACKGROUND = "#11151c";
...
export type SceneElement = StrokeElement | EraserElement | ShapeElement | TextElement | ImageElement;
