...
for (const proof of ["2026-09-07", "1,052", "19/19", "410.54 kB", "163 production dependency records", "0.153.4", "44 CSS pixel", "700 CSS pixels", "Ready with limitations"]) {
  if (!currentState.includes(proof)) failures.push(`docs/product/CURRENT_STATE.md: missing current validation proof: ${proof}`);
}
for (const proof of ["bb45368", "30661070563", "463 files", "clean local clone", "final cleanliness check all passed", "0.146.0-alpha.9.2", "0a95911", "30204589636", "927", "293", "387.70 kB", "438 files"]) {
  if (!currentState.includes(proof)) failures.push(`docs/product/CURRENT_STATE.md: missing historical validation proof: ${proof}`);
}
