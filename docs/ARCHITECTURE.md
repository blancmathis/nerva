...
The repository is therefore automated-test green but runtime-degraded, not hardware-ready or release-ready. No `v0.1.0` tag is valid until doctor and the physical checklist are both green.
